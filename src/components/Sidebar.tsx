...
export function Sidebar({ open, onClose }: SidebarProps) {
  ...
  return (
    <>
      ...
      null}
      <aside
        className={`fixed inset-y-0 left-0 z-40 flex w-[248px] flex-col border-r border-ink-200 bg-white transition-transform duration-200 ease-out lg:static lg:translate-x-0 ${
